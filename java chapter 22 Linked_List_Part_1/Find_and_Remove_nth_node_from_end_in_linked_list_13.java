public class Find_and_Remove_nth_node_from_end_in_linked_list_13 {
 ...
 if(head.data==key){ // if head.data = = key 
  ...
  Find_and_Remove_nth_node_from_end_in_linked_list_13 aman = new  Find_and_Remove_nth_node_from_end_in_linked_list_13();
   aman.printLL();
